...
app.layout = html.Div([
    ...
    dcc.Graph(id='twitter-sentiment'),
    ...
    html.H1('Reddit Correlation: ', id='correlation-reddit'),
    html.H1('Twitter Correlation: ', id='correlation-twitter'),
])
...
@app.callback(
    Output('correlation-reddit', component_property='children'),
    [Input('button', 'n_clicks')],
    state=[State(component_id='ticker', component_property='value'),
        State(component_id='person1', component_property='value'),
        State(component_id='person2', component_property='value'),
...
def get_correlation(n_clicks, ticker, p1, p2, p3, p4, start_date, end_date):
    ...
    return 'Reddit Correlation: ' + str(df['Returns'].corr(df['Score(1)']))

@app.callback(
    Output('twitter-sentiment', 'figure'),
    [Input('button', 'n_clicks')],
    state=[State(component_id='ticker', component_property='value'),
        State(component_id='person1', component_property='value'),
        State(component_id='person2', component_property='value'),
...
def get_twitter_plot(n_clicks, ticker, p1, p2, p3, p4, start_date, end_date,):
    print(ticker, start_date, end_date)
...
@app.callback(
    Output('correlation-twitter', component_property='children'),
    [Input('button', 'n_clicks')],
    state=[State(component_id='ticker', component_property='value'),
        State(component_id='person1', component_property='value'),
        State(component_id='person2', component_property='value'),
        ...
        State(component_id='date-picker', component_property='start_date'),
        State(component_id='date-picker', component_property='end_date')])
def get_twitter_correlation(n_clicks, ticker, p1, p2, p3, p4, start_date, end_date):
    import time 
    ...
    return 'Twitter Correlation: ' + str(df['Returns'].corr(df['Score(1)']))
